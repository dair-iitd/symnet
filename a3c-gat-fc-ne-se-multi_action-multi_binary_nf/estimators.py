...
class PolicyEstimator():
    ...
    def __init__(self,
        ...
        for i in range(self.N):
            ...
            self.adj_biases_placeholder_list[i] = tf.placeholder(
                dtype=tf.float32,
                shape=(None, self.num_nodes_list[i], self.num_nodes_list[i]),
                name="adj_biases_placeholder_{}".format(i))
        ...
        with tf.variable_scope("policy_net", reuse=tf.AUTO_REUSE):
            ...
            for env_i in range(self.N):
                ...
                self.gcn_hidden_list[env_i] = gat
