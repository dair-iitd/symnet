        ...
        for setting in os.listdir(path):
            ...
            if os.path.isdir(path_setting):
                ...
                try:
                    with open(
                            os.path.join(
                                path_setting, 'val_csv/{}{}.csv'.format(
                                    domain, instance)), 'r') as f:
                        data = f.readlines()[1:]
                    ...
                    result[domain][neighbourhood][instance] = (min_val,
                                                               max_val,
                                                               last_val)
    ...
    with open(os.path.join(args.log_path, 'baseline_results.csv'), 'w') as f:
        ...
        for domain, res in result.items():
            for instance in ['5', '6', '7', '8', '9', '10']:
                try:
                    f.write('{}_{},{},{},{}\n'.format(
                        domain, instance, res['1'][instance][0],
                        res['1'][instance][1], res['1'][instance][2]))
                except Exception as _:
                    pass
